...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0015_alter_dislike_options_alter_like_options'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='order_basket.order', verbose_name='سبد خرید')),
